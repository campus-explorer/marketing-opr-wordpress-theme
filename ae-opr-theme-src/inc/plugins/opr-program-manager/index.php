 ...
 * Description: Custom Settings page for managing program information.
 * Version: 1.0.0
 * Author: Jason Sonderman
 * Text Domain: ae-opr-program-manager
*/
...
function program_manager_admin_menu() {
    add_menu_page(
...
add_action( 'admin_menu', 'program_manager_admin_menu' );

function program_manager_admin_page_contents() {
	$HTML = new HTML();
...
add_action( 'admin_init', 'program_manager_settings_init' );

function program_manager_settings_init() {
    ...
    add_settings_section(
		...
		register_setting( 'sample-page', 'program_manager_setting_field' );
}


function program_manager_setting_section_callback_function() {
    echo '<p>Intro text for our settings section</p>';
}


function program_manager_setting_markup() {
    ?>
