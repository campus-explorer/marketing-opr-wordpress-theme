			...
			if ( null === self::$block_attributes ) {
				self::$block_attributes = array(
					...
					'aeopr/content-timeline'   => array(
						...
						'default'     => true,
						'js_assets'   => array( 'aeopr-timeline-js' ),
						'attributes'  => array(
							'classMigrate'            => false,
							'align'                   => 'center',
							'headingColor'            => '',
					...
					'aeopr/buttons'            => array(
						...
						'attributes'  => array(
							...
							'align'           => 'center',
							'btn_count'       => '2',
							'buttons'         => AEOPR_Helper::get_button_defaults(),
							'gap'             => 10,
							'stack'           => 'none',
							'fontFamily'      => '',
							'fontWeight'      => '',
					...
					'aeopr/post-carousel'      => array(
						...
						'default'     => true,
						'js_assets'   => array( 'aeopr-slick-js', 'aeopr-carousel-js', 'aeopr-imagesloaded' ),
						'css_assets'  => array( 'aeopr-slick-css' ),
						'attributes'  => array(
							'align'                   => 'left',
							'rowGap'                  => '20',
							'columnGap'               => '20',
					...
					'aeopr/post-masonry'       => array(
						...
						'default'     => true,
						'js_assets'   => array( 'aeopr-masonry', 'aeopr-imagesloaded' ),
						'attributes'  => array(
							'align'                   => 'left',
							'rowGap'                  => '20',
							'columnGap'               => '20',
					...
					'aeopr/social-share-child' => array(
						'slug'        => '',
					...
					'aeopr/table-of-contents'  => array(
						...
						'default'     => true,
						'js_assets'   => array( 'aeopr-table-of-contents' ),
						'attributes'  => array(
							'classMigrate'              => false,
							'block_id'                  => '',
					...
					'aeopr/testimonial'        => array(
						...
						'default'     => true,
						'js_assets'   => array( 'aeopr-slick-js' ),
						'css_assets'  => array( 'aeopr-slick-css' ),
						'attributes'  => array(
							'classMigrate'            => false,
							'headingAlign'            => 'center',
		...
		public static function get_block_assets() {
			...
			if ( null === self::$block_assets ) {
				self::$block_assets = array(
					'aeopr-timeline-js'       => array(
						'src' => AEOPR_URL . 'assets/js/timeline.js',
						'dep' => array( 'jquery' ),
					),
					'aeopr-masonry'           => array(
						'src' => AEOPR_URL . 'assets/js/isotope.min.js',
						'dep' => array( 'jquery' ),
					),
					'aeopr-imagesloaded'      => array(
						'src' => AEOPR_URL . 'assets/js/imagesloaded.min.js',
						'dep' => array( 'jquery' ),
					),
					'aeopr-table-of-contents' => array(
						'src' => AEOPR_URL . 'assets/js/table-of-contents.js',
						'dep' => array( 'jquery' ),
					),
					'aeopr-slick-js'          => array(
						'src' => AEOPR_URL . 'assets/js/slick.min.js',
						'dep' => array( 'jquery' ),
					),
					'aeopr-slick-css'         => array(
						'src' => AEOPR_URL . 'assets/css/slick.css',
						'dep' => array(),
					),
					'aeopr-carousel-js'       => array(
						'src' => AEOPR_URL . 'assets/js/post-carousel.js',
						'dep' => array( 'jquery', 'aeopr-slick-js' ),
					),
					'aeopr-faq-js'            => array(
						'src'        => AEOPR_URL . 'assets/js/faq.js',
						'dep'        => array(),
						'skipEditor' => true,
					),
				);
