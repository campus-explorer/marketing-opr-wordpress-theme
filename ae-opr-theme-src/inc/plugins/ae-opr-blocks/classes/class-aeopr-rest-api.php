...
if ( ! class_exists( 'AEOPR_Rest_API' ) ) {

	/**
	 * Class AEOPR_Rest_API.
	 */
	final class AEOPR_Rest_API {
		...
		public function blocks_register_rest_fields() {
			$post_type = AEOPR_Helper::get_post_types();

			foreach ( $post_type as $key => $value ) {
				// Add featured image source.
				register_rest_field(
					$value['value'],
					'aeopr_featured_image_src',
					array(
	...
	/**
	 *  Prepare if class 'AEOPR_Rest_API' exist.
	 *  Kicking this off by calling 'get_instance()' method
	 */
	AEOPR_Rest_API::get_instance();
}
