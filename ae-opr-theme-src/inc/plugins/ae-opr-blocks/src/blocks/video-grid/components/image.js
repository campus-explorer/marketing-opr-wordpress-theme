...
export default class PostGridImage extends Component {
	...
	render() {
		return (
			<Fragment>
				<div className={ classnames( 'aeopr-block-post-grid-image' ) }>
					<a
					...
					! this.getImageUrl() &&
						...
						'selectimage' !== this.props.imgSize && (
							<Fragment>
								<div className={ 'aeopr-post-grid-no-image-icon' }>
									<Dashicon icon={ 'warning' } />
								</div>

								<Placeholder
									className={
										'aeopr-post-grid-no-image-placeholder'
									}
								>
									<Dashicon icon={ 'info' } />
									...
									<div className="aeopr-post-grid-image-help">
										<a
											target="_blank"
											...
											href="https://github.com/studiopress/aeopr/wiki/Post-Grid-Block#featured-image-sizes"
										>
											{ __(
												'Learn more ',
												'aeopr'
