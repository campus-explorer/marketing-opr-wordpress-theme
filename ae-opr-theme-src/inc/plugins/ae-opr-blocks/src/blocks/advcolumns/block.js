/***
 * Advanced Gutenberg - Column Manager 
 ...
 (function ( wpI18n, wpBlocks, wpElement, wpBlockEditor, wpComponents ) {
    ...
    class AdvColumnsEdit extends Component {
        ...
        componentWillMount() {
            ...
            const currentBlockConfig = aeoprDefaultConfig['aeopr-column'];
        ...
        componentDidMount() {
            ...
            if ( !attributes.id ) {
                setAttributes( { colId: 'aeopr-cols-' + clientId, } )
            }
        }
        ...
        static prepareColumnClass(layout, extraClass, classObj) {
            switch (layout) {
                case '12-12':
                    for ( let i = 0; i < 2; i++) {
                        classObj[i].push('aeopr-is-half' + extraClass);
                    }
                    break;
                case '13-13-13':
                    for ( let i = 0; i < 3; i++) {
                        classObj[i].push('aeopr-is-one-third' + extraClass);
                    }
                    break;
                case '14-14-14-14':
                    for ( let i = 0; i < 4; i++) {
                        classObj[i].push('aeopr-is-one-quarter' + extraClass);
                    }
                    break;
                case 'five':
                    for ( let i = 0; i < 5; i++) {
                        classObj[i].push('aeopr-is-one-fifth' + extraClass);
                    }
                    break;
                case 'six':
                    for ( let i = 0; i < 6; i++) {
                        classObj[i].push('aeopr-is-2' + extraClass);
                    }
                    break;
                case '23-13':
                    classObj[0].push('aeopr-is-two-thirds' + extraClass);
                    classObj[1].push('aeopr-is-one-third' + extraClass);
                    break;
                case '13-23':
                    classObj[0].push('aeopr-is-one-third' + extraClass);
                    classObj[1].push('aeopr-is-two-thirds' + extraClass);
                    break;
                case '34-14':
                    classObj[0].push('aeopr-is-three-quarters' + extraClass);
                    classObj[1].push('aeopr-is-one-quarter' + extraClass);
                    break;
                case '14-34':
                    classObj[0].push('aeopr-is-one-quarter' + extraClass);
                    classObj[1].push('aeopr-is-three-quarters' + extraClass);
                    break;
                case '45-15':
                    classObj[0].push('aeopr-is-four-fifths' + extraClass);
                    classObj[1].push('aeopr-is-one-fifth' + extraClass);
                    break;
                case '15-45':
                    classObj[0].push('aeopr-is-one-fifth' + extraClass);
                    classObj[1].push('aeopr-is-four-fifths' + extraClass);
                    break;
                case '12-14-14':
                    classObj[0].push('aeopr-is-half' + extraClass);
                    classObj[1].push('aeopr-is-one-quarter' + extraClass);
                    classObj[2].push('aeopr-is-one-quarter' + extraClass);
                    break;
                case '14-14-12':
                    classObj[0].push('aeopr-is-one-quarter' + extraClass);
                    classObj[1].push('aeopr-is-one-quarter' + extraClass);
                    classObj[2].push('aeopr-is-half' + extraClass);
                    break;
                case '14-12-14':
                    classObj[0].push('aeopr-is-one-quarter' + extraClass);
                    classObj[1].push('aeopr-is-half' + extraClass);
                    classObj[2].push('aeopr-is-one-quarter' + extraClass);
                    break;
                case '15-35-15':
                    classObj[0].push('aeopr-is-one-fifth' + extraClass);
                    classObj[1].push('aeopr-is-three-fifths' + extraClass);
                    classObj[2].push('aeopr-is-one-fifth' + extraClass);
                    break;
                case '35-15-15':
                    classObj[0].push('aeopr-is-three-fifths' + extraClass);
                    classObj[1].push('aeopr-is-one-fifth' + extraClass);
                    classObj[2].push('aeopr-is-one-fifth' + extraClass);
                    break;
                case '15-15-35':
                    classObj[0].push('aeopr-is-one-fifth' + extraClass);
                    classObj[1].push('aeopr-is-one-fifth' + extraClass);
                    classObj[2].push('aeopr-is-three-fifths' + extraClass);
                    break;
                case '16-46-16':
                    classObj[0].push('aeopr-is-2' + extraClass);
                    classObj[1].push('aeopr-is-8' + extraClass);
                    classObj[2].push('aeopr-is-2' + extraClass);
                    break;
                case '1-12-12':
                    classObj[0].push('aeopr-is-full' + extraClass);
                    classObj[1].push('aeopr-is-half' + extraClass);
                    classObj[2].push('aeopr-is-half' + extraClass);
                    break;
                case '12-12-1':
                    classObj[0].push('aeopr-is-half' + extraClass);
                    classObj[1].push('aeopr-is-half' + extraClass);
                    classObj[2].push('aeopr-is-full' + extraClass);
                    break;
                case '36-16-16-16':
                    classObj[0].push('aeopr-is-half' + extraClass);
                    classObj[1].push('aeopr-is-2' + extraClass);
                    classObj[2].push('aeopr-is-2' + extraClass);
                    classObj[3].push('aeopr-is-2' + extraClass);
                    break;
                case '16-16-16-36':
                    classObj[0].push('aeopr-is-2' + extraClass);
                    classObj[1].push('aeopr-is-2' + extraClass);
                    classObj[2].push('aeopr-is-2' + extraClass);
                    classObj[3].push('aeopr-is-half' + extraClass);
                    break;
                case '25-15-15-15':
                    classObj[0].push('aeopr-is-two-fifths' + extraClass);
                    classObj[1].push('aeopr-is-one-fifth' + extraClass);
                    classObj[2].push('aeopr-is-one-fifth' + extraClass);
                    classObj[3].push('aeopr-is-one-fifth' + extraClass);
                    break;
                case '15-15-15-25':
                    classObj[0].push('aeopr-is-one-fifth' + extraClass);
                    classObj[1].push('aeopr-is-one-fifth' + extraClass);
                    classObj[2].push('aeopr-is-one-fifth' + extraClass);
                    classObj[3].push('aeopr-is-two-fifths' + extraClass);
                    break;
                case '12x4':
                    for ( let i = 0; i < 4; i++) {
                        classObj[i].push('aeopr-is-half' + extraClass);
                ...
                case 'stacked':
                    for ( let i = 0; i < 6; i++) {
                        classObj[i].push('aeopr-is-full' + extraClass);
                    }
                    break;
                default:
                    break;
        ...
        render() {
            ...
            const blockClasses = [
                ...
                columns && `aeopr-adv-columns-${columns}`,
            ...
            if (!columns) {
                return (
                    <div className="aeopr-adv-columns-select-wrapper">
                        <div className="aeopr-adv-columns-select-title">
                            { __( 'Pickup a columns layout', 'advanced-gutenberg' ) }
                        </div>
                        <div className="aeopr-adv-columns-select-layout">
                            {COLUMNS_LAYOUTS.map( (layout, index) => {
                                return (
                                    <Tooltip text={ layout.title } key={ index }>
                                        <div className="aeopr-adv-columns-layout"
                                             onClick={ () => setAttributes( {
                                                 columns: layout.columns,
                                                 columnsLayout: layout.layout
                                             } ) }
                                        >
                                            <img src={aeoprBlocks.pluginUrl + '/dist/blocks/controls/column-icons/' + layout.icon + '.png'}
                                                 alt={ layout.layout }
                                            />
                                        </div>
                                    </Tooltip>
            ...
            return (
                <Fragment>
                    ...
                    <InspectorControls>
                        <PanelBody title={ __( 'Columns Settings', 'advanced-gutenberg' ) }>
                            <PanelBody title={ __( 'Responsive Settings', 'advanced-gutenberg' ) }>
                                <div className="aeopr-adv-columns-responsive-items">
                                    {['desktop', 'tablet', 'mobile'].map( (device, index) => {
                                        const itemClasses = [
                                            "aeopr-adv-columns-responsive-item",
                                ...
                                <div className="aeopr-adv-columns-select-layout on-inspector">
                                    {COLUMNS_LAYOUTS_FILTERED.map( (layout, index) => {
                                        const layoutClasses = [
                                            'aeopr-adv-columns-layout',
                                ...
                                <PanelBody title={ tabSelected !== 'desktop' ? AdvColumnsEdit.jsUcfirst(tabSelected) + __(' Padding', 'advanced-gutenberg') : __('Padding', 'advanced-gutenberg') }
                                           initialOpen={false}
                                >
                                    <div className="aeopr-controls-title">
                                        <span>{ __( 'Unit', 'advanced-gutenberg' ) }</span>
                                        <div className="aeopr-unit-wrapper" key="unit">
                                            { ['px', 'em', 'vh', '%'].map( (unit, idx) => (
                                                <span className={`aeopr-unit ${paddingUnit === unit ? 'selected' : ''}`} key={idx}
                                ...
                                >
                                    <div className="aeopr-controls-title">
                                        ...
                                        <div className="aeopr-unit-wrapper" key="unit">
                                            { ['px', 'em', 'vh', '%'].map( (unit, idx) => (
                                                <span className={`aeopr-unit ${marginUnit === unit ? 'selected' : ''}`} key={idx}
                            ...
                            <PanelBody title={ __( 'Row Settings', 'advanced-gutenberg' ) } initialOpen={ false }>
                                ...
                                <RangeControl
                                    label={ [
                                        ...
                                        <div className="aeopr-unit-wrapper" key="unit">
                                            { ['px', 'vw', '%'].map( (unit, idx) => (
                                                <span className={`aeopr-unit ${contentMaxWidthUnit === unit ? 'selected' : ''}`} key={idx}
                                    ...
                                    label={ [
                                        ...
                                        <div className="aeopr-unit-wrapper" key="unit">
                                            { ['px', 'vw', 'vh'].map( (unit, idx) => (
                                                <span className={`aeopr-unit ${contentMinHeightUnit === unit ? 'selected' : ''}`} key={idx}
                                ...
                                <RangeControl
                                    label={ [
                                        ...
                                        <div className="aeopr-unit-wrapper" key="unit">
                                            { ['px', 'vw', 'vh'].map( (unit, idx) => (
                                                <span className={`aeopr-unit ${contentMaxHeightUnit === unit ? 'selected' : ''}`} key={idx}
                    ...
                    <span className="aeopr-adv-columns-spacing">&nbsp;</span>
                    <div className="aeopr-adv-columns-wrapper">
                        ...
                        >
                            <InnerBlocks
                                template={ times( parseInt(columns), () => [ 'aeopr/adv-column' ] ) }
                                templateLock="all"
                                allowedBlocks={ [ 'aeopr/adv-column','advgb/column' ] }
                                random={ this.state.random }
                            />
                        </div>
                    </div>
                    <style>
                        {`#block-${clientId} .aeopr-adv-columns-wrapper .aeopr-adv-columns {
    ...
    registerBlockType( 'aeopr/columns', {
        title: __( 'AEOPR Columns Manager', 'advanced-gutenberg' ),
        ...
        save: function ( { attributes } ) {
            ...
            return (
                <Tag className="aeopr-adv-columns-wrapper" id={ colId }>
                    <div className="aeopr-adv-columns-container">
                        <div className={ blockClasses }
                             style={ {
                                 maxWidth: !!contentMaxWidth ? `${contentMaxWidth}${contentMaxWidthUnit}` : undefined,
                                 minHeight: !!contentMinHeight ? `${contentMinHeight}${contentMinHeightUnit}` : undefined,
        ...
        deprecated: [
            {
                ...
                save: function ( { attributes } ) {
                    ...
                    return (
                        <Tag className="aeopr-adv-columns-wrapper">
