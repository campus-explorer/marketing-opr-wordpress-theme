 ...
 (function ( wpI18n, wpBlocks, wpElement, wpBlockEditor, wpComponents ) {
    ...
    class AdvColumnEdit extends Component {
        ...
        componentWillMount() {
            ...
            const currentBlockConfig = aeoprDefaultConfig['aeopr-adv-column'];
        ...
        componentDidMount() {
            ...
            if ( !attributes.id ) {
                setAttributes( { colId: 'aeopr-col-' + clientId, } )
            }
        }
            ...
            return (
                <Fragment>
                    <InspectorControls>
                        <PanelBody title={ __( 'Column Settings', 'advanced-gutenberg' ) }>
                            ...
                            <PanelBody title={ tabSelected !== 'desktop' ? AdvColumnEdit.jsUcfirst(tabSelected) + __(' Padding', 'advanced-gutenberg') : __('Padding', 'advanced-gutenberg') }
                                       initialOpen={false}
                            >
                                <div className="aeopr-controls-title">{ __( 'Unit (px)', 'advanced-gutenberg' ) }</div>
                    ...
                    <div className={ blockClasses }>
                        <div className="aeopr-adv-column-inner"
                             style={ {
                    ...
                    <style>
                        {`#block-${clientId} .aeopr-adv-column > .aeopr-adv-column-inner {
    ...
    registerBlockType( 'aeopr/adv-column', {
        title: __( 'Adv. Column', 'advanced-gutenberg' ),
       // parent: [ 'aeopr/adv-columns' ],
	        ...
	        
            {
                ...
                save: function ( { attributes } ) {
                    ...
                    return (
                        ...
                        >
                            <div className="aeopr-column-inner"
                                 style={ { borderStyle, borderColor, borderWidth, borderRadius, } }
                            >
                                <InnerBlocks.Content />
                            </div>
