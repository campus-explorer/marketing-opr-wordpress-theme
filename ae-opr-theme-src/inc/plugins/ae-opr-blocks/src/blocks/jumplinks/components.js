...
console.log(headingDefaultAnchor, heading, 'content default Anchor')
...
console.log( heading, 'end')
	...
	render() {
		...
		const parseList = list => {
			...
			return <ul className="aeopr-toc__list" >{items}</ul>;
		};
		...
		if (
			...
			return (
				<div style={style} className="aeopr-toc__list-wrap">
			...
			return (
				blockProp && (
					<p className="aeopr_table-of-contents-placeholder">
						{__(
