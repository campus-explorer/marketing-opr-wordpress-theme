 ...
 *
 * @uses aeopr_header_style()
 */
function aeopr_custom_header_setup() {
	add_theme_support(
		'custom-header',
		apply_filters(
			'aeopr_custom_header_args',
			array(
				'default-image'      => '',
				...
				'flex-height'        => true,
				'flex-width'         => true,
				'wp-head-callback'   => 'aeopr_header_style',
			)
		)
	);
}
add_action( 'after_setup_theme', 'aeopr_custom_header_setup' );

if ( ! function_exists( 'aeopr_header_style' ) ) :
	/**
	 * Styles the header image and text displayed on the blog.
	 *
	 * @see aeopr_custom_header_setup().
	 */
	function aeopr_header_style() {
