 ...
 */
function aeopr_blocks_register_block_core_latest_cpt() {
	...
	register_block_type(
		...
		array(
			...
			'render_callback' => 'aeopr_blocks_render_block_core_latest_cpt',
		),
	);
}
add_action( 'init', 'aeopr_blocks_register_block_core_latest_cpt' );


function aeopr_blocks_render_block_core_latest_cpt( $attributes ) {
	$args = [
	 ...
	 */
	$recent_posts = get_posts( apply_filters( 'aeopr/latest_posts/widget_posts_args', $args ) );
