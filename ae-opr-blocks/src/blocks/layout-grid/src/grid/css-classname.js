...
export function getAsCSS( columns, attributes = {} ) {
	...
	if ( ! attributes.addGutterEnds ) {
		classes[ 'wp-block-aeopr-layout-gutter__nowrap' ] = true;
	}
...
export function removeGridClasses( classes ) {
	...
	return classes
		...
		.replace( /\s{2,}/, '' )
		.replace( /wp-block-aeopr-layout-gutter__\w*/, '' )
...
export function getGutterClasses( { gutterSize, addGutterEnds } ) {
	...
	return {
		'wp-block-aeopr-layout-gutter__nowrap': ! addGutterEnds,
		'wp-block-aeopr-layout-gutter__none': gutterSize === 'none',
		'wp-block-aeopr-layout-gutter__small': gutterSize === 'small',
		'wp-block-aeopr-layout-gutter__medium': gutterSize === 'medium',
		'wp-block-aeopr-layout-gutter__huge': gutterSize === 'huge',
	};
}
