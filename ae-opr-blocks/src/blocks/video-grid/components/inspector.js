...
export default class Inspector extends Component {
	...
	/* Get the page list */
	pageSelect() {
		const getPages = wp.data.select( 'core' ).getEntityRecords( 'postType', 'video', { per_page: -1 } )
	...
	render() {
		...
		return (
			<InspectorControls>
				...
				<PanelBody
					title={ __( 'Post Grid Markup', 'aeopr' ) }
					initialOpen={ false }
					...
					{ attributes.sectionTitle && (
						<RenderSettingControl id="aeopr_postgrid_sectionTitleTag">
							<SelectControl
								...
								help={ __(
									'Change the post section title tag to match your content hierarchy.',
									'aeopr'
								) }
							/>
						</RenderSettingControl>
					...
					{ attributes.displayPostTitle && (
						<RenderSettingControl id="aeopr_postgrid_postTitleTag">
							<SelectControl
								...
								help={ __(
									'Change the post title tag to match your content hierarchy.',
									'aeopr'
								) }
							/>
						</RenderSettingControl>
