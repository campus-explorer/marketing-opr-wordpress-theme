 /***
 * Advanced Gutenberg - Advanced Accordion
 ...
 (function ( wpI18n, wpBlocks, wpElement, wpBlockEditor, wpComponents, wpCompose ) {
    ...
    class AccordionsEdit extends Component {
        ...
        componentWillMount() {
            ...
            const currentBlockConfig = aeoprDefaultConfig['aeopr-accordions'];
        ...
        render() {
            ...
            return (
                ...
                <Fragment>
                    ...
                    <div className="aeopr-accordions-wrapper">
                        <InnerBlocks
                            template={ [ ['aeopr/accordion-item'], ['aeopr/accordion-item'] ] }
                            templateLock={ false }
                            allowedBlocks={ [ 'aeopr/accordion-item' ] }
                        />
                    </div>
                </Fragment>
            )
    ...
    registerBlockType( 'aeopr/accordions', {
        title: __( 'AEOPR Advanced Accordion', 'advanced-gutenberg' ),
        ...
        save: function ( { attributes } ) {
            ...
            return (
                <div className="aeopr-accordion-wrapper" data-collapsed={ collapsedAll ? collapsedAll : undefined }>
                    <InnerBlocks.Content />
                </div>
            );
        },
