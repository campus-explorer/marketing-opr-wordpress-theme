/**
 * BLOCK: AEOPR - Section Edit Class
 */
...
class AEOPRSectionEdit extends Component {
	...
	componentDidMount() {
		...
		$style.setAttribute( "id", "aeopr-section-style-" + this.props.clientId )
	...
	render() {
		...
		var element = document.getElementById( "aeopr-section-style-" + this.props.clientId )
			...
			<Fragment>
				...
				<InspectorControls>
							...
							(
								<Fragment>
									<ButtonGroup className="aeopr-size-type-field" aria-label={ __( "Size Type" ) }>
										<Button key={ "px" } className="aeopr-size-btn" isSmall isPrimary={ innerWidthType === "px" } aria-pressed={ innerWidthType === "px" } onClick={ () => setAttributes( { innerWidthType: "px" } ) }>{ "px" }</Button>
										<Button key={ "%" } className="aeopr-size-btn" isSmall isPrimary={ innerWidthType === "%" } aria-pressed={ innerWidthType === "%" } onClick={ () => setAttributes( { innerWidthType: "%" } ) }>{ "%" }</Button>
									</ButtonGroup>
									<RangeControl
					...
					<PanelBody title={ __( "Spacing" ) } initialOpen={ false }>
						<TabPanel className="aeopr-size-type-field-tabs aeopr-size-type-field__common-tabs aeopr-inline-margin" activeClass="active-tab"
							tabs={ [
								{
									name: "desktop",
								...
								( tab ) => {
									...
									if ( "mobile" === tab.name ) {
										tabout = (
											<Fragment>
												<ButtonGroup className="aeopr-size-type-field" aria-label={ __( "Size Type" ) }>
													<Button key={ "px" } className="aeopr-size-btn" isSmall isPrimary={ mobilePaddingType === "px" } aria-pressed={ mobilePaddingType === "px" } onClick={ () => setAttributes( { mobilePaddingType: "px" } ) }>{ "px" }</Button>
													<Button key={ "%" } className="aeopr-size-btn" isSmall isPrimary={ mobilePaddingType === "%" } aria-pressed={ mobilePaddingType === "%" } onClick={ () => setAttributes( { mobilePaddingType: "%" } ) }>{ "%" }</Button>
												</ButtonGroup>
												<h2>{ __( "Padding Mobile" ) }</h2>
												<RangeControl
													label={ AEOPR_Block_Icons.top_margin }
												...
												/>
												<RangeControl
													label={ AEOPR_Block_Icons.bottom_margin }
													className={ "aeopr-margin-control" }
												...
												/>
												<RangeControl
													label={ AEOPR_Block_Icons.left_margin }
													className={ "aeopr-margin-control" }
												...
												/>
												<RangeControl
													label={ AEOPR_Block_Icons.right_margin }
													className={ "aeopr-margin-control" }
										...
										tabout = (
											<Fragment>
												<ButtonGroup className="aeopr-size-type-field" aria-label={ __( "Size Type" ) }>
													<Button key={ "px" } className="aeopr-size-btn" isSmall isPrimary={ tabletPaddingType === "px" } aria-pressed={ tabletPaddingType === "px" } onClick={ () => setAttributes( { tabletPaddingType: "px" } ) }>{ "px" }</Button>
													<Button key={ "%" } className="aeopr-size-btn" isSmall isPrimary={ tabletPaddingType === "%" } aria-pressed={ tabletPaddingType === "%" } onClick={ () => setAttributes( { tabletPaddingType: "%" } ) }>{ "%" }</Button>
												</ButtonGroup>
										...
										tabout = (
											<Fragment>
												<ButtonGroup className="aeopr-size-type-field" aria-label={ __( "Size Type" ) }>
													<Button key={ "px" } className="aeopr-size-btn" isSmall isPrimary={ desktopPaddingType === "px" } aria-pressed={ desktopPaddingType === "px" } onClick={ () => setAttributes( { desktopPaddingType: "px" } ) }>{ "px" }</Button>
													<Button key={ "%" } className="aeopr-size-btn" isSmall isPrimary={ desktopPaddingType === "%" } aria-pressed={ desktopPaddingType === "%" } onClick={ () => setAttributes( { desktopPaddingType: "%" } ) }>{ "%" }</Button>
												</ButtonGroup>
												<h2>{ __( "Padding" ) }</h2>
												<RangeControl
													label={ AEOPR_Block_Icons.top_margin }
								...
								( tab ) => {
									...
									if ( "mobile" === tab.name ) {
										tabout = (
											<Fragment>
												<ButtonGroup className="aeopr-size-type-field" aria-label={ __( "Size Type" ) }>
													<Button key={ "px" } className="aeopr-size-btn" isSmall isPrimary={ mobileMarginType === "px" } aria-pressed={ mobileMarginType === "px" } onClick={ () => setAttributes( { mobileMarginType: "px" } ) }>{ "px" }</Button>
													<Button key={ "%" } className="aeopr-size-btn" isSmall isPrimary={ mobileMarginType === "%" } aria-pressed={ mobileMarginType === "%" } onClick={ () => setAttributes( { mobileMarginType: "%" } ) }>{ "%" }</Button>
												</ButtonGroup>
										...
										tabout = (
											<Fragment>
												<ButtonGroup className="aeopr-size-type-field" aria-label={ __( "Size Type" ) }>
													<Button key={ "px" } className="aeopr-size-btn" isSmall isPrimary={ tabletMarginType === "px" } aria-pressed={ tabletMarginType === "px" } onClick={ () => setAttributes( { tabletMarginType: "px" } ) }>{ "px" }</Button>
													<Button key={ "%" } className="aeopr-size-btn" isSmall isPrimary={ tabletMarginType === "%" } aria-pressed={ tabletMarginType === "%" } onClick={ () => setAttributes( { tabletMarginType: "%" } ) }>{ "%" }</Button>
												</ButtonGroup>
										...
										tabout = (
											<Fragment>
												<ButtonGroup className="aeopr-size-type-field" aria-label={ __( "Size Type" ) }>
													<Button key={ "px" } className="aeopr-size-btn" isSmall isPrimary={ desktopMarginType === "px" } aria-pressed={ desktopMarginType === "px" } onClick={ () => setAttributes( { desktopMarginType: "px" } ) }>{ "px" }</Button>
													<Button key={ "%" } className="aeopr-size-btn" isSmall isPrimary={ desktopMarginType === "%" } aria-pressed={ desktopMarginType === "%" } onClick={ () => setAttributes( { desktopMarginType: "%" } ) }>{ "%" }</Button>
												</ButtonGroup>
												<h2>{ __( "Margin" ) }</h2>
												<RangeControl
													label={ AEOPR_Block_Icons.top_margin }
								...
								{ backgroundImage &&
									( <Fragment>
										...
										{ "gradient" == overlayType &&
											( <Fragment>
												<p className="aeopr-setting-label">{ __( "Color 1" ) }<span className="components-base-control__label"><span className="component-color-indicator" style={{ backgroundColor: backgroundVideoColor }} ></span></span></p>
												<ColorPalette
												...
												<RangeControl
													...
													allowReset
												/>
												<p className="aeopr-setting-label">{ __( "Color 2" ) }<span className="components-base-control__label"><span className="component-color-indicator" style={{ backgroundColor: backgroundVideoColor }} ></span></span></p>
												<ColorPalette
...
export default withNotices( AEOPRSectionEdit )
