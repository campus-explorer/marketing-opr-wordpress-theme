/**
 * BLOCK: Post Grid Block - Edit Class
 */
...
class AEOPRPostGrid extends Component {
	...
	componentDidMount() {
		...
		$style.setAttribute( "id", "aeopr-style-post-grid-block-" + this.props.clientId )
